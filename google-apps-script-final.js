...
// Sistema de Reservas Ultra Simplificado - VERSIÓN FINAL
// ========================================
...
const STATUS_COLUMN = 10 // Columna J (Estado) - índice 10 (base 1)
const EMAIL_COLUMN = 3 // Columna C (Email) - índice 3 (base 1)
const RESERVATION_NUMBER_COLUMN = 11 // Columna K (Número Reserva) - índice 11 (base 1)
...
function doPost(e) {
  try {
    ...
    // Preparar datos para insertar (ultra simplificado)
    const rowData = [
      ...
      reservationDetails.totalUSD, // E: Total USD
      reservationDetails.finalTotalVEF, // F: Total VEF
      transactionReference, // G: Referencia Pago
      "ENTRADA GENERAL", // H: Tipo
      "PROCESO SIMPLIFICADO", // I: Comprobante
      "PENDIENTE", // J: Estado
      "", // K: Número Reserva
      `ID: ${solicitudId}`, // L: Notas
    ]
...
function onEdit(e) {
  try {
    ...
    // Verificar si es la columna de Estado (J = columna 10)
    ...
    const reservationData = {
      ...
      totalUSD: rowData[4],
      totalVEF: rowData[5],
      referenciaPago: rowData[6],
      tipo: rowData[7],
      comprobante: rowData[8],
      estado: rowData[9],
      numeroReserva: rowData[10],
      notas: rowData[11],
    }
