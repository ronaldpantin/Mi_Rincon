...
import { Calendar, Users, Mail, MessageCircle, Loader2 } from "lucide-react"
import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/popover"
import { Calendar as DatePicker } from "@/components/ui/calendar" // Renombrado para evitar conflicto
import { format } from "date-fns"
import { cn } from "@/lib/utils"

interface SmallGroupsFormProps {
  onBackToSelector: () => void
}

export default function SmallGroupsForm({ onBackToSelector }: SmallGroupsFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Solicitud de Grupo Pequeño enviada:", {
      contactName,
      contactEmail,
      contactPhone,
      estimatedGuests,
      ...
      <Card className="rounded-xl border-emerald-200">
        ...
        <CardContent className="space-y-6">
          <p className="text-sm text-emerald-700">
            Ideal para cumpleaños, reuniones familiares, bodas íntimas o grupos escolares pequeños (más de 40 personas).
            Por favor, completa el siguiente formulario y nos pondremos en contacto contigo para coordinar los detalles.
          </p>
          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="estimatedGuests" className="text-emerald-800">
              ...
              <div className="space-y-2">
                <Label htmlFor="eventType" className="text-emerald-800">
                  Tipo de Evento (Cumpleaños, Reunión, etc.)
                </Label>
                <Input
                  id="eventType"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="specialRequests"
                  placeholder="Ej: Necesitamos área de juegos y catering para 50 personas."
