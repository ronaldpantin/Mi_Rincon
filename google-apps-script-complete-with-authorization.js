...
// Sistema de Reservas Completo con Autorización Automática
// ========================================
...
function testEmailAutorizacion() {
  console.log("=== PRUEBA DE EMAIL DE AUTORIZACIÓN ===")

  const testReservationData = {
    fechaHora: new Date(),
    nombreCompleto: "Juan Pérez",
    email: "juan.perez@example.com", // CAMBIA ESTE EMAIL POR UNO REAL PARA PROBAR
  ...
  const testNumeroReserva = "RES-TEST-" + new Date().getTime()

  enviarEmailConfirmacionConQR(testReservationData, testNumeroReserva, 999)
