...
// Sistema de Reservas Simplificado (Sin fecha ni contadores)
// ========================================
...
function doPost(e) {
  try {
    ...
    // Preparar datos para insertar (sin fecha ni contadores)
    const rowData = [
      ...
      "SIN FECHA ESPECÍFICA", // E: Fecha Visita
      "N/A", // F: Adultos
      "N/A", // G: Niños
      ...
      "PENDIENTE", // L: Estado
      "", // M: Número Reserva
      `ID: ${solicitudId} | Edad: ${reservationDetails.bookerAge} | CI: ${reservationDetails.bookerIdNumber}`, // N: Notas
    ]
